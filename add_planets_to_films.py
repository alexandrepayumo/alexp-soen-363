...
film_planet_links = [
    {"film_id": 1, "planet_id": 4},   # A New Hope -> Tatooine
    {"film_id": 1, "planet_id": 5},   # A New Hope -> Alderaan
    {"film_id": 2, "planet_id": 7},   # Empire Strikes Back -> Hoth
    {"film_id": 3, "planet_id": 4},   # Return of the Jedi -> Tatooine
    {"film_id": 4, "planet_id": 11}, # Phantom Menace -> Naboo
    {"film_id": 5, "planet_id": 11}, # Attack of the Clones -> Naboo
    {"film_id": 6, "planet_id": 12}, # Revenge of the Sith -> Coruscant
]
